...
driver.get('https://uliving-admin.elabs.xyz/unit/Santos/feedback/suggestions')
time.sleep(5)
...
for n in range(len(pagination) - 2):
    for i in range(len(usuario)):
        ...
        sugestoes.append(temporary_data)
    if True:
        driver.find_element('xpath', '/html/body/app-root/app-content/div/div/div[2]/app-list-suggestions/div[2]/div/div/div/ngb-pagination/ul/li[6]').click()
    else:
        break
    time.sleep(3)
...
sugestoes.to_excel('sugestoes.xlsx')
